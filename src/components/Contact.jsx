        ...
        <div className="flex flex-col justify-center h-full space-y-12 md:pl-12 border-t-4 border-black md:border-t-0 md:border-l-4 pt-12 md:pt-0">
          ...
          >
            <div className="flex items-center space-x-4">
              <div className="bg-black text-white p-4 group-hover:bg-red-600 transition-colors">
              ...
              <div>
                ...
                <span className="text-2xl font-black uppercase tracking-tighter group-hover:text-red-600 transition-colors">
                  @kingsford.music
                </span>
              </div>
            </div>
