...
import VinylStack from './VinylStack'; // Import the reusable component

const Contact = () => {
  const formAction = "https://formspree.io/f/xkogoaya";
  
  // Ref to track scroll progress for this specific section
  const sectionRef = useRef(null);

  // Setup scroll tracking for the background records
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        {/* VinylStack Layer - Subtly moving behind the form */}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start relative z-10 text-black">
        ...
        {/* Left Side: Expanded Email Inquiry Form */}
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input 
                ...
                required
                placeholder="Name" 
                className="w-full p-4 border-2 border-black font-bold uppercase text-xs tracking-widest focus:bg-black focus:text-white transition-all outline-none bg-white/50 backdrop-blur-sm"
              />
              <input 
                name="email"
                type="email" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <input 
                ...
                type="text" 
                placeholder="IG Handle (e.g. @artist)" 
                className="w-full p-4 border-2 border-black font-bold uppercase text-xs tracking-widest focus:bg-black focus:text-white transition-all outline-none bg-white/50 backdrop-blur-sm"
              />
            </div>
            ...
            <textarea 
              ...
              className="w-full p-4 border-2 border-black font-bold uppercase text-xs tracking-widest focus:bg-black focus:text-white transition-all outline-none resize-none bg-white/50 backdrop-blur-sm"
            ></textarea>
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-black text-white py-5 font-black uppercase tracking-[0.3em] text-sm hover:bg-red-600 transition-colors"
            >
              Send Inquiry
            </motion.button>
          </form>
        ...
        <div className="flex flex-col justify-center h-full space-y-12 md:pl-12 border-t-4 border-black md:border-t-0 md:border-l-4 pt-12 md:pt-0">
          ...
          >
            <div className="flex items-center space-x-4 group cursor-pointer">
              <div className="bg-black text-white p-4 transition-all duration-300 rounded-xl 
