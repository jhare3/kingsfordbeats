          ...
          <div className="w-full md:w-1/2 relative">
            <div className="relative z-10 border-l-4 border-white/20 pl-8">
              ...
              <p className="text-gray-400 text-lg leading-relaxed max-w-md italic">
                "Every note is a story. <br />
                Every sample a memory. <br />
                Every loop is a heartbeat. <br />
                Every beat is a journey <br />
                <br />
                into the sound of the soul. <br />
                Don't chase Perfection, Make art."
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-300 font-light leading-relaxed">
                <p>
                  ...
                  In a world of AI and clinical, programmed loops, we chase the **authentically human** frequencies that make a listener feel something real.
                  Listeners' and artisits' expectations are evolving, but they will always crave beats that breathe life, soul, and raw emotion.
                </p>
                <p>
              ...
              <div className="grid grid-cols-2 gap-8 pt-8 border-t border-white/5">
                <div>
                  <div className="text-4xl font-black text-white uppercase">100%</div>
